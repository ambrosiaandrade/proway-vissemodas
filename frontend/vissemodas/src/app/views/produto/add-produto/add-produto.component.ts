...
export class AddProdutoComponent implements OnInit {
  ...
  addProduto() {
    ...
    const PRODUTO: Produto = {
        ...
        tamanho: this.produtoForm.get('descricao')?.value,
        valorUnitario: this.produtoForm.get('descricao')?.value,
        status: this.produtoForm.get('descricao')?.value,
        imagem: this.produtoForm.get('descricao')?.value,
        categoria: this.produtoForm.get('descricao')?.value
    }
